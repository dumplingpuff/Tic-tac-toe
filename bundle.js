...
/***/ function(module, exports, __webpack_require__) {
	...
	var checkDiag = function checkDiag() {
	...
	var switchMove = function switchMove() {
	  if (move === 'X') {
	    move = 'O';
	    return move;
	  } else if (move === 'O') {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createGame = function createGame(e) {
	  e.preventDefault();
	  $.ajax({
	    url: myApp.baseUrl + '/sign-up',
	    method: 'POST',
